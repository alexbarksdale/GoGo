...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63,
	...
	0x0a, 0x03, 0x63, 0x70, 0x75, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x43, 0x50, 0x55, 0x52, 0x03,
	0x63, 0x70, 0x75, 0x12, 0x26, 0x0a, 0x03, 0x72, 0x61, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x14, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	...
	0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x47, 0x50, 0x55, 0x52, 0x04, 0x67, 0x70,
	0x75, 0x73, 0x12, 0x31, 0x0a, 0x08, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x73, 0x18, 0x07,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62,
	...
	0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63,
	...
	0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63,
...
var file_laptop_message_proto_goTypes = []interface{}{
	(*Laptop)(nil),                // 0: grpc3.pcbook.Laptop
	(*CPU)(nil),                   // 1: grpc3.pcbook.CPU
	(*Memory)(nil),                // 2: grpc3.pcbook.Memory
	(*GPU)(nil),                   // 3: grpc3.pcbook.GPU
	(*Storage)(nil),               // 4: grpc3.pcbook.Storage
	(*Screen)(nil),                // 5: grpc3.pcbook.Screen
	(*Keyboard)(nil),              // 6: grpc3.pcbook.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: grpc3.pcbook.Laptop.cpu:type_name -> grpc3.pcbook.CPU
	2, // 1: grpc3.pcbook.Laptop.ram:type_name -> grpc3.pcbook.Memory
	3, // 2: grpc3.pcbook.Laptop.gpus:type_name -> grpc3.pcbook.GPU
	4, // 3: grpc3.pcbook.Laptop.storages:type_name -> grpc3.pcbook.Storage
	5, // 4: grpc3.pcbook.Laptop.screen:type_name -> grpc3.pcbook.Screen
	6, // 5: grpc3.pcbook.Laptop.keyboard:type_name -> grpc3.pcbook.Keyboard
	7, // 6: grpc3.pcbook.Laptop.updated_at:type_name -> google.protobuf.Timestamp
