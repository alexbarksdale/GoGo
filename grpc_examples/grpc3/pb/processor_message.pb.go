...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x33,
	...
	0x01, 0x28, 0x02, 0x52, 0x06, 0x6d, 0x61, 0x78, 0x47, 0x68, 0x7a, 0x22, 0x8f, 0x01, 0x0a, 0x03,
	...
	0x14, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: grpc3.pcbook.CPU
	(*GPU)(nil),    // 1: grpc3.pcbook.GPU
	(*Memory)(nil), // 2: grpc3.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: grpc3.pcbook.GPU.memory:type_name -> grpc3.pcbook.Memory
