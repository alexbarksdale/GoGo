...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpc3.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70,
	...
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e,
	...
	0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: grpc3.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: grpc3.pcbook.Storage
	(*Memory)(nil),      // 2: grpc3.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpc3.pcbook.Storage.driver:type_name -> grpc3.pcbook.Storage.Driver
	2, // 1: grpc3.pcbook.Storage.memory:type_name -> grpc3.pcbook.Memory
