...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=grpc3.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x32, 0x1f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	...
	0x05, 0x70, 0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67,
	0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x61, 0x6e, 0x65, 0x6c, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x57, 0x4f, 0x4e, 0x10,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: grpc3.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: grpc3.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: grpc3.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpc3.pcbook.Screen.resolution:type_name -> grpc3.pcbook.Screen.Resolution
	0, // 1: grpc3.pcbook.Screen.panel:type_name -> grpc3.pcbook.Screen.Panel
